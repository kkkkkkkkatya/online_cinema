...
async def test_register_user_conflict(client, db_session, seed_user_groups):
    ...
    response_first = await client.post("/api/accounts/register/", json=payload)
    ...
    response_second = await client.post("/api/accounts/register/", json=payload)
...
async def test_activate_account_success(client, db_session, seed_user_groups):
    ...
    registration_response = await client.post("/api/accounts/register/", json=registration_payload)
    ...
    activation_response = await client.post("/api/accounts/activate/", json=activation_payload)
...
async def test_request_password_reset_token_success(client, db_session, seed_user_groups):
    ...
    reset_response = await client.post("/api/accounts/password-reset/request/", json=reset_payload)
...
async def test_reset_password_success(client, db_session, seed_user_groups):
    ...
    reset_request_response = await client.post("/api/accounts/password-reset/request/", json=reset_request_payload)
    ...
    reset_response = await client.post("/api/accounts/reset-password/complete/", json=reset_payload)
...
async def test_reset_password_invalid_email(client, db_session):
    ...
    response = await client.post("/api/accounts/reset-password/complete/", json=reset_payload)
...
async def test_reset_password_invalid_token(client, db_session, seed_user_groups):
    ...
    response = await client.post("/api/accounts/register/", json=registration_payload)
    ...
    reset_request_payload = {"email": registration_payload["email"]}
    response = await client.post("/api/accounts/password-reset/request/", json=reset_request_payload)
    ...
    response = await client.post("/api/accounts/reset-password/complete/", json=reset_complete_payload)
...
async def test_reset_password_expired_token(client, db_session, seed_user_groups):
    ...
    reset_response = await client.post("/api/accounts/reset-password/complete/", json=reset_complete_payload)
...
async def test_login_user_success(client, db_session, jwt_manager, seed_user_groups):
    ...
    response = await client.post("/api/accounts/login/", json=login_payload)
...
async def test_login_user_invalid_cases(client, db_session, seed_user_groups):
    ...
    response = await client.post("/api/accounts/login/", json=login_payload_incorrect_password)
...
async def test_refresh_access_token_success(client, db_session, jwt_manager, seed_user_groups):
    ...
    login_response = await client.post("/api/accounts/login/", json=login_payload)
    assert login_response.status_code == 201, "Expected status code 201 for successful login."
    login_data = login_response.json()
    refresh_token = login_data["refresh_token"]

    refresh_payload = {"refresh_token": refresh_token}
    refresh_response = await client.post("/api/accounts/refresh/", json=refresh_payload)
